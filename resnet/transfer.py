...
if __name__ == '__main__':
    ...
    model = Model(net, loss_fn=ls, optimizer=opt, metrics={'acc', 'acc_without_others'})
    ...
    if args_opt.do_train:
        ...
        ckpoint_cb = ModelCheckpoint(prefix="train_resnet_transfer", directory="/home/twang/BDCI2021/checkpoint/ckpt_transfer_backup", config=config_ck)
        loss_cb = LossMonitor()
