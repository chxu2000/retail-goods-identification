...
from mindspore.nn import Momentum, SGD
...
# parser.add_argument('--checkpoint_path', type=str, default='/data/home/twang/BDCI2021/gloreresnet200_ascend_v130_imagenet2012_research_cv_bs128_top1acc79.95__top5acc94.89.ckpt', help='CheckPoint file path.')
...
if __name__ == '__main__':
    ...
    if args_opt.do_train:
        ...
        ckpoint_cb = ModelCheckpoint(prefix="ckpt_transfer_sgd_mixup_ls", directory="/home/twang/BDCI2021/checkpoint/ckpt_transfer_sgd_mixup_ls", config=config_ck)
        loss_cb = LossMonitor()
