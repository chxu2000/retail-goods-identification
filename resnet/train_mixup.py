...
def create_dataset(repeat_num=1, training=True):
    ...
    mixup_op = P.MixUp(batch_size=128, alpha=0.2, is_single=False)
    cifar_ds = cifar_ds.map(operations=[random_horizontal_op, resize_op, rescale_op, normalize_op, changeswap_op, mixup_op], input_columns=["image"], output_columns=["image"])
