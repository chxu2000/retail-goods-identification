...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, metavar='DIR', default='/home/xiangsheng/XUCHENHAO/MindSpore/all/test', help='path to dataset')
    parser.add_argument('--dataset', type=str, default='bdci', choices=['ImageNet', 'CIFAR10', 'bdci'],
                        help='ImageNet, CIFAR10 or bdci')
    parser.add_argument('--platform', type=str, default='CPU', choices=('GPU', 'CPU'), help='run platform')
